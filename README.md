...
- Hadoop, HBase 등을 이용하여 대용량 데이터 분석<br>
- 시각화 툴을 활용한 프로젝트 진행 (Tableau, Superset)<br>
- 다양한 가설을 설정 및 실험 후 서비스 개선 프로젝트 진행<br>
- 프로그래밍 개발 역량 쌓기<br>
- 분석가와 밀접하게 협업하며 데이터 활용을 위한 추출, 마트/지표 설계, 모델링, 시각화 작업
